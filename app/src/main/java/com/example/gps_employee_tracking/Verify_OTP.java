...
//                        });
        ...
        if (SharedPrefManager.getInstance(this).isVerified()) {
            ...
            Intent intent = new Intent(Verify_OTP.this, Verify_OTP.class);
        }
    ...
    private void setup_OTPInputs(){
        inputcode1.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!s.toString().trim().isEmpty()){inputcode2.requestFocus();}
            }
        ...
        inputcode2.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!s.toString().trim().isEmpty()){inputcode3.requestFocus();}
            }
        ...
        inputcode3.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!s.toString().trim().isEmpty()){inputcode4.requestFocus();}
            }
        ...
        inputcode4.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!s.toString().trim().isEmpty()){inputcode5.requestFocus();}
            }
        ...
        inputcode5.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!s.toString().trim().isEmpty()){inputcode6.requestFocus();}
            }
    ...
    private void Back_OTPInputs(){
        inputcode2.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(s.toString().trim().isEmpty()){inputcode1.requestFocus();}
            }
